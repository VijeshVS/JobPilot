...
def insert_candidate_and_skills(resume_json_path: Path , skill_json_path: Path):
    # Load JSON
...
# skill_json_path ="C:\\Users\\ajayr\\OneDrive\\Documents\\ML\\LAB\\resume_parser\\skill_verification.json"

# result = insert_candidate_and_skills(json_path,skill_json_path)
